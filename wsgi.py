...
def application(environ, start_response):
        ...
        if environ['PATH_INFO'] == '/health':
                ...
                response_body = '\n'.join(response_body)
        elif environ['PATH_INFO'] == '/covers':
                qs = environ['QUERY_STRING']
                response_body = covers.getArt(qs)
        elif environ['PATH_INFO'] == '/news':
                start_response('307 Temporary Redirect', [('Location',pn.get_url('News'))])
                return ['1']
        else:
                ctype = 'text/html'
...
<head>
  ...
  <title>Clarkson NGROK tunnels</title>
<style>
